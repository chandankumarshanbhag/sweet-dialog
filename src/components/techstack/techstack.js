        ...
        <>
            ...
            <div className={classes.root}>
                <div className={classes.tech}>
                    ...
                    <h4 style={{ fontWeight: "500" }}><Link href="https://reactjs.org/" target="_blank">ReactJs</Link></h4>
                </div>
                <div className={classes.tech}>
                    <img src={FluentGif} style={{ transform: "scale(1.5)" }} />
                    <h4 style={{ fontWeight: "500" }}><Link href="https://www.microsoft.com/design/fluent/#/" target="_blank">Fluent Design System</Link></h4>
            </div>
            <div className={classes.tech}>
                ...
                <h4 style={{ fontWeight: "500" }}><Link href="https://firebase.google.com/docs/functions" target="_blank">Cloud Functions for Firebase</Link></h4>
            </div>
            <div className={`${classes.tech}`}>
                <img className=" bounce-5" src={DialogFlow} style={{ transform: "scale(0.8)" }} />


                <h4 style={{ fontWeight: "500" }}><Link href="https://cloud.google.com/dialogflow" target="_blank">Dialogflow</Link></h4>
            </div>
        </div>
        </>
    )
